...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function insereTablePesquisa(codigo, cpf, rg, nome, nascimento, telefone, uf) {
            ...
            text += "   <td>" + cpf + "</td>";
            text += "   <td>" + nome + "</td>";
            text += "   <td style='vertical-align:middle; text-align:center'>" + nascimento + "</td>";
            ...
            text += "   <a href='Cliente.aspx?codigo=" + codigo + "' class='action btn btn-outline btn-primary btn-xs glyphicon glyphicon-edit' data-toggle='tooltip' data-placement='top' title='dados cadastrais' />";
            text += "   <a href='Cliente.aspx?codigo=" + codigo + "' class='action btn btn-outline btn-primary btn-xs glyphicon glyphicon-edit' data-toggle='tooltip' data-placement='top' title='dados cadastrais' />";
            text += "   </td>";
			text += "</tr>";
                ...
                <div class="col-md-12">
                    <div class="panel-body">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <button type="button" id="btnBuscar" class="btn btn-default">
                                                    ...
                                                    <button type="button" id="btnRelatorio" class="btn btn-default display-none">
                                                    <i class="fa fa-search"></i> Relatório de Clientes</button>
                        ...
                        <div class="form-group align-center">
                            <a href='Cliente.aspx' class="btn btn-primary"><i class="fa fa-check"></i> Cadastrar Cliente</a>
                        </div>
